...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontFamily: 'Figtree_800ExtraBold', fontSize: 19, letterSpacing: -0.3 },
  ...
  modeText: { fontFamily: 'Figtree_700Bold', fontSize: 13.5 },
  label: { fontFamily: 'Figtree_600SemiBold', fontSize: 12.5, marginBottom: 6 },
  input: { borderWidth: 1, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontFamily: 'Figtree_500Medium', fontSize: 15, marginBottom: 14 },
  ...
  suggestText: { fontFamily: 'Figtree_700Bold', fontSize: 11 },
  ...
  hintText: { fontFamily: 'Figtree_500Medium', fontSize: 12 },
  strengthBar: { height: 4, borderRadius: 99, marginTop: 10, overflow: 'hidden' },
  strengthFill: { height: 4, borderRadius: 99 },
  strengthLabel: { fontFamily: 'Figtree_600SemiBold', fontSize: 11, marginTop: 4 },
  error: { fontFamily: 'Figtree_600SemiBold', fontSize: 13, lineHeight: 18, marginBottom: 12 },
  submitBtn: { height: 52, borderRadius: 14, alignItems: 'center', justifyContent: 'center', marginTop: 2 },
  submitText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  forgotLinkBtn: { alignSelf: 'center', paddingVertical: 12, paddingHorizontal: 8 },
  forgotLink: { fontFamily: 'Figtree_700Bold', fontSize: 13 },
  forgotIntro: { fontFamily: 'Figtree_500Medium', fontSize: 13.5, lineHeight: 19, marginBottom: 16 },
  codeInput: { letterSpacing: 6, fontFamily: 'Figtree_700Bold', fontSize: 18, textAlign: 'center' },
});
