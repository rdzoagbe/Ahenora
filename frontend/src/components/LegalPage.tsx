              ...
              {Array.isArray(section.body) ? (
                section.body.map((item) => (
                  <View key={item} style={styles.bulletRow}>
                    <Text style={[styles.bullet, { color: theme.colors.accentInk }]}>•</Text>
...
const styles = StyleSheet.create({
  ...
  backText: { fontFamily: 'Figtree_700Bold', fontSize: 13 },
  eyebrow: { fontFamily: 'Figtree_800ExtraBold', fontSize: 12, textTransform: 'uppercase', letterSpacing: 1.3 },
  title: { fontFamily: 'Figtree_800ExtraBold', fontSize: 38, lineHeight: 43, letterSpacing: -0.8, marginTop: 8 },
  subtitle: { fontFamily: 'Figtree_500Medium', fontSize: 16, lineHeight: 24, marginTop: 10 },
  updated: { fontFamily: 'Figtree_600SemiBold', fontSize: 13, marginTop: 12, marginBottom: 10 },
  card: {
    borderRadius: 24,
    borderWidth: 1,
    padding: 18,
  ...
  sectionTitle: { fontFamily: 'Figtree_800ExtraBold', fontSize: 19, lineHeight: 25, marginBottom: 8 },
  body: { flex: 1, fontFamily: 'Figtree_500Medium', fontSize: 15, lineHeight: 23 },
  bulletRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, marginTop: 6 },
  bullet: { fontFamily: 'Figtree_800ExtraBold', fontSize: 17, lineHeight: 23 },
  footer: { fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 20, textAlign: 'center', marginTop: 24 },
});
