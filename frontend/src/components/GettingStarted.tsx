...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  title: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 17, letterSpacing: -0.3 },
  sub: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 13, marginTop: 1 },
  dismiss: { padding: 6 },
  ...
  rowText: { flex: 1, color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 15 },
