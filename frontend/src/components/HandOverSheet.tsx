...
const createStyles = (ui: UIColors) =>
  StyleSheet.create({
    ...
    note: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13.5, lineHeight: 20 },
    hint: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 4 },
    profileRow: {
    ...
    avatarText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 17 },
    profileName: { flex: 1, color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 16.5 },
    pinInput: {
    ...
    error: { color: ui.danger, fontFamily: 'Figtree_700Bold', fontSize: 13 },
