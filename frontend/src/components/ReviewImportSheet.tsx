...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  bulkText: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 12 },
  sub: { color: ui.muted, fontFamily: 'Figtree_400Regular', fontSize: 13, marginTop: 4, marginBottom: 10 },
  scroll: { flexGrow: 0 },
  scrollInner: { paddingBottom: 8, gap: 8 },
  empty: { color: ui.muted, fontFamily: 'Figtree_400Regular', fontSize: 14, paddingVertical: 24, textAlign: 'center' },
  item: {
  ...
  itemTitle: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 15 },
  textOff: { textDecorationLine: 'line-through' },
  metaRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  meta: { color: ui.muted, fontFamily: 'Figtree_400Regular', fontSize: 12, flexShrink: 1 },
  footer: {
  ...
  ctaOff: { opacity: 0.6 },
  ctaText: { color: '#fff', fontFamily: 'Figtree_700Bold', fontSize: 15 },
});
