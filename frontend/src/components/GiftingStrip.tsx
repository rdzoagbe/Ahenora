...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  soloHeadText: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5, letterSpacing: -0.1, textTransform: 'uppercase' },
  ...
  segText: { color: ui.muted, fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5, letterSpacing: -0.1 },
  segTextOn: { color: ui.orangeText },

  head: { flexDirection: 'row', alignItems: 'center', gap: 9, paddingBottom: 2 },
  title: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 15, letterSpacing: -0.2 },
  monthLine: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 11.5, marginTop: 8, marginLeft: 2 },
  emptyTab: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13, textAlign: 'center', paddingVertical: 18 },
  ...
  dayD: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 16, lineHeight: 17, fontVariant: ['tabular-nums'] },
  dayM: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 9, letterSpacing: 0.4, textTransform: 'uppercase', marginTop: 1 },
  santaBadge: { width: 38, height: 38, borderRadius: 11, backgroundColor: ui.orangeSoft, alignItems: 'center', justifyContent: 'center' },
  name: { flex: 1, minWidth: 0, color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 14.5 },
  sub: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 11.5, marginTop: 1 },
  chip: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 11, backgroundColor: ui.orangeSoft, borderRadius: 99, paddingHorizontal: 9, paddingVertical: 3, fontVariant: ['tabular-nums'] },
  start: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 12 },
  ...
  newText: { color: ui.orangeText, fontFamily: 'Figtree_700Bold', fontSize: 12.5 },
