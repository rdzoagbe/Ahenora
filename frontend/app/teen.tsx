...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  errorText: { fontFamily: 'Figtree_500Medium', fontSize: 14, color: ui.muted, textAlign: 'center', lineHeight: 21 },
  ...
  retryText: { fontFamily: 'Figtree_700Bold', fontSize: 13.5, color: ui.orangeText },
  ...
  chatTitle: { flex: 1, textAlign: 'center', fontFamily: 'Figtree_800ExtraBold', fontSize: 17, color: ui.text },
  brand: { fontFamily: 'Figtree_800ExtraBold', fontSize: 13, letterSpacing: 1.6, color: ui.orangeText },
  ...
  badgeText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 10, letterSpacing: 0.4, textTransform: 'uppercase', color: ui.orangeText },
  ...
  starsCount: { fontFamily: 'Figtree_800ExtraBold', fontSize: 18, color: ui.text },
  starsSub: { fontFamily: 'Figtree_500Medium', fontSize: 12.5, color: ui.muted, marginTop: 2 },
  noteStrip: {
  ...
  sectionTitle: { fontFamily: 'Figtree_800ExtraBold', fontSize: 18, letterSpacing: -0.2, color: ui.text },
  ...
  taskTitle: { fontFamily: 'Figtree_700Bold', fontSize: 15, color: ui.text },
  taskTitleDone: { color: ui.muted, textDecorationLine: 'line-through' },
  taskMeta: { fontFamily: 'Figtree_500Medium', fontSize: 12.5, color: ui.muted, marginTop: 2 },
  waitingMeta: { fontFamily: 'Figtree_700Bold', fontSize: 12, color: ui.orangeText, marginTop: 2 },
  ...
  shopHint: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 19, paddingTop: 14 },
  ...
  shopBtnText: { color: '#fff', fontFamily: 'Figtree_700Bold', fontSize: 15 },
  shopNote: { color: ui.mintText, fontFamily: 'Figtree_600SemiBold', fontSize: 13, paddingBottom: 14 },
  empty: { fontFamily: 'Figtree_500Medium', fontSize: 14, color: ui.muted, paddingVertical: 4 },
  ...
  privacyText: { flex: 1, fontFamily: 'Figtree_500Medium', fontSize: 12, lineHeight: 17, color: ui.muted },
});
