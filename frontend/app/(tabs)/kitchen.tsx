...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  tabText: { fontFamily: 'Figtree_700Bold', fontSize: 13, color: ui.muted },
  ...
  ideasCtaText: { color: ui.lavenderText, fontFamily: 'Figtree_700Bold', fontSize: 14 },
  histRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12, borderTopWidth: 1, borderTopColor: ui.line },
  histTitle: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15 },
  histSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 2 },
  histEmpty: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 14, textAlign: 'center', paddingVertical: 24 },
  ...
  reuseText: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 12 },
  ...
  restoreTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  restoreSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 1 },
  restoreCta: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 13 },
  restoreSelRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 },
  restoreSelText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  ...
  selAllText: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 12.5 },
  ...
  secTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 19, letterSpacing: -0.3, flexShrink: 1 },
  secCount: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 14 },
  ...
  histPillText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 12 },
  clearBtnText: { color: ui.mintText, fontFamily: 'Figtree_700Bold', fontSize: 12 },
  ...
  scanHint: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 11.5, marginBottom: 10, marginTop: 2 },
  regularsWrap: { marginTop: 4, marginBottom: 8 },
  regularsLabel: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 12, marginBottom: 8 },
  ...
  regularChipText: { color: ui.lavenderText, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  ...
  scanUnsure: { color: ui.goldText, fontFamily: 'Figtree_600SemiBold', fontSize: 11, marginTop: 1 },
  scanRetake: { alignItems: 'center', paddingVertical: 12, marginTop: 4 },
  scanRetakeText: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  // An error a parent has to read; the hardcoded salmon failed AA at 13px.
  scanError: { color: ui.danger, fontFamily: 'Figtree_500Medium', fontSize: 13, marginBottom: 10 },
  ...
  scanSourceText: { color: ui.orangeText, fontFamily: 'Figtree_600SemiBold', fontSize: 14 },
  captureTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 22, letterSpacing: -0.4, lineHeight: 27 },
  shopInput: { flex: 1, borderWidth: 1, borderColor: ui.line, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10, fontFamily: 'Figtree_500Medium', fontSize: 14, color: ui.text, backgroundColor: ui.soft },
  ...
  rowCheaper: {
    color: ui.mintText, fontFamily: 'Figtree_500Medium', fontSize: 11.5, marginTop: 1,
  },
  ...
  mealDayLabel: { color: ui.lavenderText, fontFamily: 'Figtree_800ExtraBold', fontSize: 12, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 8, marginBottom: 2 },
  mealTip: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, lineHeight: 19, marginTop: 12 },
  ...
  keepAwakeText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 12.5 },
  ...
  selectModeText: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 12 },
  ...
  selCancelText: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 12 },
  selDeleteBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    paddingVertical: 9, paddingHorizontal: 14, borderRadius: 999,
    backgroundColor: ui.danger,
  },
  selDeleteText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 12 },
  ...
  clearAllText: { color: ui.danger, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  ...
  suggestCtaText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 14 },
  suggestSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13.5, lineHeight: 20, marginBottom: 8 },
  suggestRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 13, borderTopWidth: 1, borderTopColor: ui.line },
  suggestDay: { color: ui.lavenderText, fontFamily: 'Figtree_800ExtraBold', fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.5 },
  suggestTitle: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15.5, marginTop: 1 },
  suggestHave: { color: ui.mintText, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 3 },
  suggestNeed: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 2 },
  ...
  suggestAddText: { color: ui.lavenderText, fontFamily: 'Figtree_800ExtraBold', fontSize: 13 },
  suggestAllBtn: { alignItems: 'center', justifyContent: 'center', minHeight: 52, borderRadius: 99, backgroundColor: ui.lavenderText },
  suggestAllText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  ...
  stepBtn: { padding: 6 },
  stepCount: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 16, minWidth: 20, textAlign: 'center' },
  ...
  qtyName: { flex: 1, color: ui.text, fontFamily: 'Figtree_500Medium', fontSize: 15 },
  qtyAmount: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 14 },
  qtyNote: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, marginTop: 8, fontStyle: 'italic' },
  ...
  addMissingText: { color: ui.orangeText, fontFamily: 'Figtree_600SemiBold', fontSize: 14 },
  ...
  recipeAiLabelText: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 11.5, letterSpacing: 0.8, textTransform: 'uppercase' },
  recipeAiRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  recipeAiInput: { flex: 1, borderWidth: 1, borderColor: ui.line, borderRadius: 12, paddingHorizontal: 13, paddingVertical: 10, fontFamily: 'Figtree_600SemiBold', fontSize: 14.5, color: ui.text, backgroundColor: ui.soft },
  ...
  recipeAiBtnText: { color: '#fff', fontFamily: 'Figtree_800ExtraBold', fontSize: 13.5 },
  recipeAiHint: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 11.5, marginTop: 8 },
  browseRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: ui.line },
  browseTitle: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 15 },
  browseIng: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, marginTop: 2 },
  ...
  recipeTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 28, letterSpacing: -0.5, lineHeight: 34 },
  recipeLoading: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 14 },
  recipeLoadingText: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 14 },
  ...
  recipeAddText: { color: '#fff', fontFamily: 'Figtree_700Bold', fontSize: 15 },
  ...
  chefChipText: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  ...
  recipeActionText: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  ...
  vegBadgeText: { color: ui.mintText, fontFamily: 'Figtree_700Bold', fontSize: 12, letterSpacing: 0.2 },
  ...
  vegToggleText: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  ...
  chefAnswerText: { color: ui.text, fontFamily: 'Figtree_500Medium', fontSize: 15, lineHeight: 22 },
  chefAnswerNote: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, marginTop: 8, fontStyle: 'italic' },
  ...
  browseDayText: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  ...
  againText: { color: ui.orangeText, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  cookLink: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 6 },
  cookLinkText: { color: ui.orangeText, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  cookMeta: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 4 },
  cookMetaText: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13 },
  cookSectionTitle: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15, marginTop: 18, marginBottom: 8 },
  cookIngredients: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 14, lineHeight: 20 },
  ...
  cookStepNumText: { color: ui.orangeText, fontFamily: 'Figtree_700Bold', fontSize: 14 },
  cookStepText: { flex: 1, color: ui.text, fontFamily: 'Figtree_500Medium', fontSize: 16, lineHeight: 25 },
  ...
  cookServeWithDot: { color: ui.orangeText, fontFamily: 'Figtree_700Bold', fontSize: 16, lineHeight: 25 },
  cookServeWithText: { flex: 1, color: ui.text, fontFamily: 'Figtree_500Medium', fontSize: 16, lineHeight: 25 },
  cookSeasoningNote: {
    color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13.5, lineHeight: 19, marginBottom: 8,
  },
  cookSeasoningRow: {
    borderRadius: 12, backgroundColor: ui.soft, paddingHorizontal: 12, paddingVertical: 10,
    marginBottom: 6, gap: 2,
  },
  cookSeasoningName: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15, lineHeight: 20 },
  cookSeasoningWhy: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 18 },
  ...
  plannerAllergenText: {
    flex: 1, fontFamily: 'Figtree_600SemiBold', fontSize: 12.5, lineHeight: 17, color: ui.orangeText,
  },
  suggestAllergen: { flexDirection: 'row', gap: 8, alignItems: 'flex-start', marginTop: 4, marginBottom: 12 },
  suggestAllergenText: { flex: 1, color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, lineHeight: 17 },
  cookAllergenText: { flex: 1, color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 18 },
  ...
  mealDayChipText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 13, textTransform: 'capitalize' },
