...
const createStyles = (ui: UIColors) =>
  ...
  navTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 20, letterSpacing: -0.3 },
  ...
  avatarText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 26 },
  pictureSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 18, marginBottom: 10 },
  name: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 19, lineHeight: 24 },
  email: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 14, marginTop: 3 },
  ...
  rowTitle: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 14.5 },
  rowSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 2 },
  googleG: { color: ui.blueText, fontFamily: 'Figtree_800ExtraBold', fontSize: 18 },
  actionLink: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 14 },

  diagCard: { marginTop: 12, paddingVertical: 14, gap: 9 },
  diagLine: { flexDirection: 'row', justifyContent: 'space-between', gap: 14 },
  diagLabel: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  diagValue: { flex: 1, textAlign: 'right', fontFamily: 'Figtree_800ExtraBold', fontSize: 13 },
  diagError: { color: ui.danger, fontFamily: 'Figtree_700Bold', fontSize: 13, lineHeight: 19, marginTop: 4 },
  ...
  modalTitle: { fontFamily: 'Figtree_800ExtraBold', fontSize: 20, letterSpacing: -0.3 },
  modalCloseBtn: { width: 34, height: 34, borderRadius: 99, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  modalLabel: { fontFamily: 'Figtree_600SemiBold', fontSize: 13, marginBottom: 6 },
  modalInput: { borderWidth: 1, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontFamily: 'Figtree_500Medium', fontSize: 15, marginBottom: 16 },
  ...
  modalSendText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
});
