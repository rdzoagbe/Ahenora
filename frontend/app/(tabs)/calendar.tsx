...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  pendingPillText: {
    color: ui.orangeText, fontFamily: 'Figtree_600SemiBold', fontSize: 13, flex: 1,
  },
  ...
  morningNoticeText: { flex: 1, color: ui.mintText, fontFamily: 'Figtree_600SemiBold', fontSize: 12.5, lineHeight: 17 },
  morningDismiss: { padding: 2 },
  bannerGap: { marginTop: 18 },
  banner: { padding: 14 },
  bannerInner: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  bannerText: { flex: 1, color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 18 },
  ...
  monthTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 18, letterSpacing: -0.2 },
  weekHeader: { flexDirection: 'row', alignSelf: 'center', marginBottom: 6 },
  weekLabel: { textAlign: 'center', fontFamily: 'Figtree_700Bold', fontSize: 12, color: ui.muted },
  ...
  // everybody else.
  weekNumText: { fontFamily: 'Figtree_600SemiBold', fontSize: 9.5, color: ui.muted, letterSpacing: -0.2 },
  ...
  viewToggleText: { fontFamily: 'Figtree_700Bold', fontSize: 13, color: ui.muted },
  ...
  custodyLegendText: { fontFamily: 'Figtree_600SemiBold', fontSize: 12, color: ui.muted, flexShrink: 1 },
  ...
  custodySetupText: { fontFamily: 'Figtree_700Bold', fontSize: 13, color: ui.lavenderText },
  custodyModalSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 14, lineHeight: 20, marginTop: 8, marginBottom: 18 },
  custodyToggleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
  custodyToggleLabel: { flex: 1, color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15 },
  ...
  carpoolAddText: { color: ui.orangeText, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  carpoolEmpty: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13.5, lineHeight: 20, paddingVertical: 14 },
  ...
  cpDayText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  ...
  cpTimeInput: { flex: 1, paddingVertical: 12, fontFamily: 'Figtree_600SemiBold', fontSize: 15, color: ui.text },
  ...
  cpKidText: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 13.5 },
  cpKidTextOn: { color: ui.orangeText, fontFamily: 'Figtree_700Bold' },
  ...
  cpSaveText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  custodyFieldLabel: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 14, marginTop: 20, marginBottom: 10 },
  custodyInput: { borderWidth: 1, borderColor: ui.line, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, fontFamily: 'Figtree_500Medium', fontSize: 15, color: ui.text, backgroundColor: ui.soft },
  ...
  custodySaveText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  ...
  weekDayLabel: { fontFamily: 'Figtree_700Bold', fontSize: 11 },
  ...
  addEventText: { color: ui.orangeText, fontFamily: 'Figtree_700Bold', fontSize: 12.5 },
  dayNumber: { fontFamily: 'Figtree_700Bold', fontSize: 15.5, includeFontPadding: false, textAlign: 'center' },
  ...
  dayHeadTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 19, letterSpacing: -0.3, flex: 1 },
  dayHeadCount: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 14 },
  ...
  emptyText: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 17, textAlign: 'center' },
  emptyHint: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13.5, lineHeight: 20, textAlign: 'center', marginTop: 6 },
  ...
  emptySyncText: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 14 },
  ...
  earlierText: { fontFamily: 'Figtree_600SemiBold', fontSize: 12.5, color: ui.muted },
  earlierEmpty: {
  ...
  timeText: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 15, lineHeight: 18 },
  ampmText: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 11 },
  ...
  eventTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 15, lineHeight: 20 },
  eventSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 2 },
  ...
  potChipText: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 11 },
  ...
  detailChipText: { flex: 1, color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 14, lineHeight: 20 },
  ...
  giftPotBtnText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 16 },
  ...
  shareBtnText: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  ...
  sharedBadgeText: { color: ui.mintText, fontFamily: 'Figtree_700Bold', fontSize: 14 },
  ...
  shareNudgeText: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 14, lineHeight: 20 },
  ...
  shareNudgeBtnText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  coparentLink: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 12, paddingVertical: 6 },
  importPickerSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13.5, lineHeight: 20, marginTop: 4 },
  importOption: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: ui.line },
  importOptionText: { flex: 1, color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15 },
  importCancel: { marginTop: 16, alignItems: 'center', paddingVertical: 13, borderRadius: 999, backgroundColor: ui.soft },
  importCancelText: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 14 },
  coparentLinkTitle: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 14 },
  coparentLinkSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 2 },
  coparentTitleWrap: { flexDirection: 'row', alignItems: 'center', gap: 9, flex: 1 },
  coparentSubtitle: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 19, marginTop: 4, marginBottom: 4 },
  coparentEmpty: { alignItems: 'center', gap: 12, paddingVertical: 34 },
  coparentEmptyText: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 14, textAlign: 'center', paddingHorizontal: 24, lineHeight: 20 },
  ...
  coparentRowTitle: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15 },
  coparentRowMeta: { flex: 1, minWidth: 0, color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5 },

  sharePanel: { padding: 13 },
  shareHead: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  shareTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  shareMoreBtn: { alignItems: 'center', paddingVertical: 11, marginTop: 4 },
  shareMoreText: { color: ui.orangeText, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  ...
  shareSegText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 12.5 },
  ...
  shareRuleText: { flex: 1, color: ui.orangeText, fontFamily: 'Figtree_600SemiBold', fontSize: 12.5, lineHeight: 18 },
  makePrivateBtn: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 999, borderWidth: 1, borderColor: ui.orange },
  makePrivateText: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5 },
  shareTag: { backgroundColor: ui.mint, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 2 },
  shareTagText: { color: ui.mintText, fontFamily: 'Figtree_800ExtraBold', fontSize: 10, letterSpacing: 0.4, textTransform: 'uppercase' },
  shareMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 7, marginTop: 4 },
  shareCountLabel: { color: ui.muted, fontFamily: 'Figtree_800ExtraBold', fontSize: 11, letterSpacing: 0.5, textTransform: 'uppercase', marginTop: 16 },
  sharePrivateNote: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, lineHeight: 18, textAlign: 'center', marginTop: 14, paddingHorizontal: 8 },

  carpoolSection: { marginTop: 24 },
  carpoolHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10 },
  carpoolTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 17 },
  carpoolRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: ui.line },
  carpoolName: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15 },
  carpoolSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, marginTop: 2, textTransform: 'capitalize' },
});
