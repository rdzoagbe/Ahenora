                  ...
                  <View style={styles.tabRow}>
                    {(['rewards', 'stars', 'history'] as const).map((tab) => (
                      <PressScale key={tab} testID={`kids-tab-${tab}`} onPress={() => { setKidsTab(tab); if (tab === 'history' && activeChild) refreshHistory(activeChild.member_id); }} style={[styles.tabBtn, kidsTab === tab && { borderBottomColor: ui.orange }]}>
                        <Text style={[styles.tabText, { color: kidsTab === tab ? ui.text : ui.muted, fontFamily: kidsTab === tab ? 'Figtree_800ExtraBold' : 'Figtree_600SemiBold' }]}>
...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  manageBtnText: { fontFamily: 'Figtree_700Bold', fontSize: 12.5, color: ui.orangeText },

  // Family Hub — the grown-ups roster
  hubGrownups: { marginTop: 4, marginBottom: 4 },
  hubLabel: { fontFamily: 'Figtree_800ExtraBold', fontSize: 11, letterSpacing: 0.8, textTransform: 'uppercase', color: ui.muted, marginLeft: 4, marginBottom: 8, marginTop: 8 },
  ...
  hubAvatarText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 16, color: '#fff' },
  hubNameRow: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  hubName: { fontFamily: 'Figtree_700Bold', fontSize: 15, color: ui.text, flexShrink: 1 },
  hubBadge: { borderRadius: 999, paddingHorizontal: 8, paddingVertical: 2 },
  hubBadgeText: { fontFamily: 'Figtree_700Bold', fontSize: 10, letterSpacing: 0.3, textTransform: 'uppercase' },
  hubSub: { fontFamily: 'Figtree_400Regular', fontSize: 12.5, color: ui.muted, marginTop: 2 },
  ...
  stopAlwText: { color: ui.danger, fontFamily: 'Figtree_700Bold', fontSize: 13.5 },
  ...
  hubUnreadText: { color: '#fff', fontFamily: 'Figtree_800ExtraBold', fontSize: 11 },
  ...
  teenMsgText: { fontFamily: 'Figtree_700Bold', fontSize: 11.5, color: ui.orangeText },
  leadLabel: { fontFamily: 'Figtree_800ExtraBold', fontSize: 11, letterSpacing: 0.8, textTransform: 'uppercase', color: ui.muted, marginTop: 18, marginBottom: 9, marginLeft: 2 },
  ...
  leadStarText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 15, color: '#fff' },
  ...
  takeBackText: { fontFamily: 'Figtree_600SemiBold', fontSize: 13, color: ui.muted },
  ...
  todayText: { flex: 1, fontFamily: 'Figtree_600SemiBold', fontSize: 14, color: ui.text },
  todayVal: { fontFamily: 'Figtree_800ExtraBold', fontSize: 13, color: ui.mintText },
  ...
  moreTitle: { fontFamily: 'Figtree_700Bold', fontSize: 14.5, color: ui.text },
  moreSub: { fontFamily: 'Figtree_400Regular', fontSize: 12, color: ui.muted, marginTop: 2 },
  ...
  hubStarChipText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 13, color: ui.mintText },
  hubAddRow: { borderStyle: 'dashed' },
  hubAddText: { fontFamily: 'Figtree_700Bold', fontSize: 15, color: ui.text },
  ...
  focusTitle: { flex: 1, fontFamily: 'Figtree_800ExtraBold', fontSize: 22, letterSpacing: -0.3, color: ui.text },
  ...
  focusMsgText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5 },
  ...
  childAvatarText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 13 },
  ...
  childChipText: { fontFamily: 'Figtree_700Bold', fontSize: 14 },
  ...
  walletAvatarText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 20 },
  walletLabel: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 13, flexShrink: 1 },
  ...
  managePillText: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 12 },
  helperText: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, marginTop: 6, lineHeight: 17 },
  inlineLink: { alignSelf: 'flex-start', paddingVertical: 8, paddingHorizontal: 2 },
  inlineLinkText: { color: ui.danger, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  walletCount: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 30, lineHeight: 35, marginTop: 1 },
  ...
  assignTaskText: { color: ui.orangeText, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  ...
  assignDueText: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
  assignDueTextActive: { color: ui.orangeText },
  assignTaskHint: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 8, marginBottom: 14, lineHeight: 18 },
  redeemText: { color: ui.bg, fontFamily: 'Figtree_800ExtraBold', fontSize: 14 },

  weekCard: { marginTop: 12, padding: 16 },
  weekTop: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  weekLabel: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 11.5, letterSpacing: 1, textTransform: 'uppercase' },
  weekNum: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 28, marginTop: 2 },
  weekNumUnit: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  cashInBtn: { backgroundColor: ui.orangeDeep, borderRadius: 999, paddingHorizontal: 16, paddingVertical: 10 },
  cashInText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 13 },
  weekGoalWrap: { marginTop: 14 },
  weekGoalRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 },
  weekGoalTitle: { flex: 1, color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 14 },
  weekGoalCount: { color: ui.muted, fontFamily: 'Figtree_800ExtraBold', fontSize: 13 },
  weekGoalHint: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 12, marginTop: 8 },
  ...
  weekDayMark: { color: ui.muted, fontFamily: 'Figtree_800ExtraBold', fontSize: 13, lineHeight: 17 },
  weekDayMarkDone: { color: ui.mintText },
  weekDayMarkToday: { color: ui.orangeText },
  weekDayLetter: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 10, marginTop: 2 },
  ...
  weekDayHint: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 11.5, lineHeight: 16, marginTop: 8 },
  ...
  weekClaimedTagText: { color: ui.mintText, fontFamily: 'Figtree_800ExtraBold', fontSize: 12 },
  weekResetNote: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 11.5, lineHeight: 16, marginTop: 12 },
  ...
  blockLabel: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 13, marginTop: 20, marginBottom: 10 },
  blockHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 22, marginBottom: 10 },
  blockTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 17, letterSpacing: -0.2 },
  cardPad: { paddingHorizontal: 16 },

  quickAddHead: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between' },
  quickAddDay: { color: ui.mintText, fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5 },
  quickAddMaths: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, lineHeight: 17, marginTop: 8 },
  ...
  quickAddText: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 12, textAlign: 'center' },
  quickAddAmt: { color: ui.mintText, fontFamily: 'Figtree_800ExtraBold', fontSize: 13 },
  ...
  rewardRedeemText: { color: ui.bg, fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5 },
  ...
  pendingTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 14.5 },
  pendingMeta: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 12, marginTop: 3 },
  ...
  owedBadgeText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 8.5 },

  ideaCard: { padding: 16 },
  ideaLead: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, lineHeight: 18, marginBottom: 12 },
  ...
  ideaTitle: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 12.5 },
  ...
  addStarsText: { color: ui.bg, fontFamily: 'Figtree_800ExtraBold', fontSize: 14 },
  ...
  removeStarsText: { color: ui.muted, fontFamily: 'Figtree_800ExtraBold', fontSize: 14 },
  ...
  quickStarText: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  ...
  activityReason: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 14 },
  activityDate: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, marginTop: 2 },
  activityDeltaRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  activityDelta: { fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  emptyMini: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 13, paddingVertical: 14 },
  ...
  moneyBtnText: { fontFamily: 'Figtree_700Bold', fontSize: 14 },
  ...
  moneyDesc: { flex: 1, color: ui.text, fontFamily: 'Figtree_500Medium', fontSize: 14 },
  moneyAmount: { fontFamily: 'Figtree_700Bold', fontSize: 14 },
  sheetHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  sheetTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 24, letterSpacing: -0.4 },
  sheetHelp: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 14, marginBottom: 12 },
  iconBtn: { padding: 9, borderRadius: 9999, borderWidth: 1, borderColor: ui.line, backgroundColor: ui.soft },
  label: { color: ui.muted, fontFamily: 'Figtree_800ExtraBold', fontSize: 12, textTransform: 'uppercase', letterSpacing: 1, marginTop: 14, marginBottom: 8 },
  input: { borderWidth: 1, borderColor: ui.line, borderRadius: 16, paddingHorizontal: 15, paddingVertical: 13, fontFamily: 'Figtree_500Medium', fontSize: 16, color: ui.text, backgroundColor: ui.soft },
  teenPageTextBox: { backgroundColor: ui.orangeSoft, borderRadius: 14, padding: 14, marginBottom: 12 },
  teenPageText: { fontFamily: 'Figtree_600SemiBold', fontSize: 14, lineHeight: 20, color: ui.orangeText },
  teenChipBadge: { backgroundColor: ui.orangeSoft, borderRadius: 99, paddingHorizontal: 7, paddingVertical: 2, marginLeft: 6 },
  teenChipBadgeText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 9, letterSpacing: 0.3, textTransform: 'uppercase' },
  ...
  teenHintNew: { fontFamily: 'Figtree_800ExtraBold', fontSize: 10, letterSpacing: 0.4, color: '#2A0E02', backgroundColor: ui.orange, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 99, overflow: 'hidden' },
  teenHintText: { flex: 1, fontFamily: 'Figtree_600SemiBold', fontSize: 12.5, color: ui.orangeText, lineHeight: 17 },
  ...
  approvalsTitle: { fontFamily: 'Figtree_800ExtraBold', fontSize: 16, color: ui.text, letterSpacing: -0.2 },
  approvalsSub: { fontFamily: 'Figtree_500Medium', fontSize: 12.5, color: ui.muted, marginTop: 2, marginBottom: 10 },
  approvalRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 9, borderTopWidth: 1, borderTopColor: '#F1EFEA' },
  approvalTask: { fontFamily: 'Figtree_700Bold', fontSize: 14.5, color: ui.text },
  approvalWho: { fontFamily: 'Figtree_500Medium', fontSize: 12, color: ui.muted, marginTop: 1 },
  approvalDismiss: { paddingHorizontal: 12, paddingVertical: 9, borderRadius: 99, backgroundColor: ui.bg },
  approvalDismissText: { fontFamily: 'Figtree_600SemiBold', fontSize: 12.5, color: ui.muted },
  ...
  approvalApproveText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5, color: '#fff' },
  ...
  giveAccountText: { fontFamily: 'Figtree_700Bold', fontSize: 14, color: ui.text },
  teenHelp: { fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 19, color: ui.muted, marginTop: 4, marginBottom: 14 },
  ...
  ageValue: { fontFamily: 'Figtree_800ExtraBold', fontSize: 22, color: ui.text, minWidth: 34, textAlign: 'center' },
  teenSendBtn: { backgroundColor: ui.orange, borderRadius: 14, paddingVertical: 15, alignItems: 'center', marginTop: 18 },
  teenSendText: { color: '#fff', fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  ...
  cancelText: { color: ui.muted, fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  ...
  deleteText: { color: ui.danger, fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  saveBtn: { flex: 1, borderRadius: 18, paddingVertical: 15, alignItems: 'center', backgroundColor: ui.orangeDeep },
  saveText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 15 },
  ...
  featureHeaderBtnText: { fontFamily: 'Figtree_700Bold', fontSize: 12 },
  featureEmpty: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 19, paddingVertical: 6 },
  ...
  sheetToggleText: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 14 },
  sheetToggleHint: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, marginTop: 2 },
  featureHeaderText: { flex: 1, color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 17 },
  featureRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: ui.line },
  featureRowTitle: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15 },
  featureRowSub: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, marginTop: 2 },
  ...
  freqChipText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  freqChipTextActive: { color: ui.bg },
  pocketTip: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 19, marginTop: 14 },
  ...
  featureActionText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 12 },
  allowanceRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12 },
  allowanceBalance: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 28 },
  allowanceDue: { color: ui.orangeText, fontFamily: 'Figtree_700Bold', fontSize: 12, marginTop: 3 },
  payNowBtn: { backgroundColor: ui.orangeDeep, borderRadius: 99, paddingHorizontal: 14, paddingVertical: 9 },
  payNowText: { color: '#FFFFFF', fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5 },
});
