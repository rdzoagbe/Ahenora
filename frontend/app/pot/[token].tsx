...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  kicker: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5, letterSpacing: 0.4, textTransform: 'uppercase', textAlign: 'center' },
  heroTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 24, textAlign: 'center', marginTop: 8, letterSpacing: -0.4 },
  note: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 14, fontStyle: 'italic', textAlign: 'center', marginTop: 10, lineHeight: 20 },
  ...
  meta: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 13, marginTop: 10 },

  card: { backgroundColor: ui.card, borderRadius: 18, borderWidth: 1, borderColor: ui.line, padding: 18 },
  joinTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 18, marginBottom: 14 },
  input: { backgroundColor: ui.bg, borderRadius: 12, borderWidth: 1, borderColor: ui.line, color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 16, paddingHorizontal: 14, paddingVertical: 13 },
  fieldLabel: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 12.5, marginTop: 16, marginBottom: 8 },
  ...
  euro: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 17, marginRight: 5 },
  amountInput: { flex: 1, color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 17, paddingVertical: 13 },
  ...
  methodText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 13 },
  ...
  closedNote: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 14, textAlign: 'center', paddingVertical: 20 },
  invalidText: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 15, textAlign: 'center' },
  thanksTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 22, textAlign: 'center' },
  thanksBody: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 14.5, textAlign: 'center', marginTop: 10, lineHeight: 21 },
  brandFoot: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 12, textAlign: 'center', marginTop: 26, opacity: 0.8 },
});
