...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  introTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 19, textAlign: 'center' },
  introBody: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 13.5, lineHeight: 19, textAlign: 'center', marginTop: 7, marginBottom: 6 },

  label: { color: ui.muted, fontFamily: 'Figtree_800ExtraBold', fontSize: 11, letterSpacing: 0.5, textTransform: 'uppercase', marginTop: 16, marginBottom: 7, marginLeft: 2 },
  ...
  fieldInput: { flex: 1, color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15, paddingVertical: 13 },
  fieldValue: { flex: 1, color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 15, paddingVertical: 13, marginLeft: 8 },
  fieldPlaceholder: { color: ui.muted, fontFamily: 'Figtree_600SemiBold' },
  euro: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 15, marginRight: 4 },
  two: { flexDirection: 'row', gap: 10 },

  card: { backgroundColor: ui.card, borderRadius: 16, borderWidth: 1, borderColor: ui.line, padding: 6, paddingHorizontal: 12 },
  emptyRow: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 14, textAlign: 'center', paddingVertical: 12 },
  ...
  avatarText: { color: '#fff', fontFamily: 'Figtree_800ExtraBold', fontSize: 13 },
  rowName: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 14.5 },
  rowMeta: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 11.5, marginTop: 1 },
  phoneWrap: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 2 },
  phoneInput: { flex: 1, color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 12.5, paddingVertical: 2 },
  ...
  addChipText: { color: ui.orangeText, fontFamily: 'Figtree_700Bold', fontSize: 12.5 },
  ...
  addBtnText: { color: '#fff', fontFamily: 'Figtree_800ExtraBold', fontSize: 14 },

  keepApart: { marginTop: 14, backgroundColor: ui.card, borderWidth: 1, borderColor: ui.line, borderRadius: 14, padding: 13 },
  keepApartTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 13, marginBottom: 8 },
  keepApartHint: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, marginTop: 10, lineHeight: 17, marginLeft: 2 },
  pairRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 5 },
  pairText: { color: ui.text, fontFamily: 'Figtree_700Bold', fontSize: 13.5 },

  errorText: { color: ui.danger, fontFamily: 'Figtree_600SemiBold', fontSize: 13, textAlign: 'center', marginTop: 14 },
  ...
  lockNote: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, marginTop: 12, textAlign: 'center' },
  ...
  ghostBtnText: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 14 },
  ...
  matchedTitle: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 21, marginBottom: 4 },
  ...
  checkText: { color: ui.text, fontFamily: 'Figtree_600SemiBold', fontSize: 13.5 },
  blindNote: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12.5, lineHeight: 18, textAlign: 'center', marginTop: 16 },
  ...
  sentBig: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 40, lineHeight: 44 },
  sentOf: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 22 },
  sentLabel: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 13, textTransform: 'capitalize', marginTop: 2 },

  pillMint: { backgroundColor: ui.mint, borderRadius: 99, paddingHorizontal: 10, paddingVertical: 4 },
  pillMintText: { color: ui.mintText, fontFamily: 'Figtree_800ExtraBold', fontSize: 11 },
  ...
  pillOrangeText: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 11.5 },
  pillLine: { backgroundColor: ui.soft, borderRadius: 99, paddingHorizontal: 10, paddingVertical: 4 },
  pillLineText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 11 },
  copiedMsg: { color: ui.mintText, fontFamily: 'Figtree_600SemiBold', fontSize: 12.5, textAlign: 'center', marginTop: 10 },
  footnote: { color: ui.muted, fontFamily: 'Figtree_500Medium', fontSize: 12, textAlign: 'center', lineHeight: 18, marginTop: 16 },
  ...
  revealKicker: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 12, letterSpacing: 0.8, textTransform: 'uppercase', marginTop: 4 },
  revealName: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 38, marginTop: 8, textAlign: 'center' },
  revealChips: { flexDirection: 'row', gap: 8, marginTop: 16 },
  revealSecret: { color: ui.mintText, fontFamily: 'Figtree_700Bold', fontSize: 12.5, backgroundColor: ui.mint, paddingHorizontal: 13, paddingVertical: 8, borderRadius: 99, marginTop: 22, textAlign: 'center', overflow: 'hidden' },
});
