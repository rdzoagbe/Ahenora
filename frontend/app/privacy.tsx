// Generated by scripts/build_legal.py from legal/privacy.json — do not edit by hand.
      ...
      sections={[
        {
          ...
          body: [
            'Ahenora is built and operated by Roland Dzoagbe, who is the data controller for the purposes of the UK and EU GDPR. Contact: rolanddzoagbe@gmail.com.',
        ...
        {
          title: 'Messages inside your household',
          body: [
        ...
        },
        {
          ...
          body: [
            ...
            'If you are in the UK or the EEA and you think we have got this wrong, you can complain to your data protection authority. In the UK that is the Information Commissioner\'s Office.',
          ],
        },
        {
          title: 'Your controls in the app',
          body: [
