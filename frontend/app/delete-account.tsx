...
const styles = StyleSheet.create({
  ...
  formTitle: { fontFamily: 'Figtree_800ExtraBold', fontSize: 18 },
  formSub: { fontFamily: 'Figtree_500Medium', fontSize: 13, lineHeight: 18, marginTop: 4, marginBottom: 4 },
  input: {
    minHeight: 48,
    borderWidth: 1,
    borderRadius: 16,
  ...
  buttonText: { fontFamily: 'Figtree_800ExtraBold', fontSize: 15, color: '#FFFFFF' },
});
