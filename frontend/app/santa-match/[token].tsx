...
const createStyles = (ui: UIColors) => StyleSheet.create({
  ...
  drawTitle: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 13, textAlign: 'center', marginBottom: 4 },
  kicker: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5, letterSpacing: 0.6, textTransform: 'uppercase', textAlign: 'center', marginTop: 6 },
  name: { color: ui.text, fontFamily: 'Figtree_800ExtraBold', fontSize: 42, textAlign: 'center', marginTop: 8, letterSpacing: -0.6 },
  ...
  pillOrangeText: { color: ui.orangeText, fontFamily: 'Figtree_800ExtraBold', fontSize: 12.5 },
  pillLine: { backgroundColor: ui.soft, borderRadius: 99, paddingHorizontal: 13, paddingVertical: 7 },
  pillLineText: { color: ui.muted, fontFamily: 'Figtree_700Bold', fontSize: 12.5 },
  secret: { color: ui.mintText, fontFamily: 'Figtree_700Bold', fontSize: 13, backgroundColor: ui.mint, paddingHorizontal: 14, paddingVertical: 9, borderRadius: 99, marginTop: 24, textAlign: 'center', overflow: 'hidden' },
  brandFoot: { color: ui.muted, fontFamily: 'Figtree_600SemiBold', fontSize: 12, textAlign: 'center', marginTop: 22, opacity: 0.8 },
