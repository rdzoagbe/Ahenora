...
const chipStyles = StyleSheet.create({
  ...
  text: { fontFamily: 'Figtree_600SemiBold', fontSize: 13 },
});
...
const createStyles = (c: any) =>
  StyleSheet.create({
    ...
    custodyChipText: { fontFamily: 'Figtree_700Bold', fontSize: 13 },
    container: { flex: 1 },
    ...
    sub: { fontFamily: 'Figtree_400Regular', fontSize: 15, lineHeight: 22, marginTop: 10, marginBottom: 8 },
    ...
    rowText: { fontFamily: 'Figtree_600SemiBold', fontSize: 16 },
    ...
    valueText: { flex: 1, fontFamily: 'Figtree_500Medium', fontSize: 14.5, lineHeight: 20 },
    sectionLabel: { fontFamily: 'Figtree_700Bold', fontSize: 12, letterSpacing: 0.6, textTransform: 'uppercase', marginTop: 20 },
    subSmall: { fontFamily: 'Figtree_400Regular', fontSize: 13, lineHeight: 19, marginTop: 6 },
    ...
    tryText: { flex: 1, fontFamily: 'Figtree_600SemiBold', fontSize: 13.5, lineHeight: 19 },
    input: { flex: 1, paddingVertical: 15, fontFamily: 'Figtree_500Medium', fontSize: 16 },
